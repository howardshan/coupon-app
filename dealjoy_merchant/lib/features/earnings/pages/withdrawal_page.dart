...
class WithdrawalPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final settingsAsync = ref.watch(withdrawalSettingsProvider);
...
class _BalanceCard extends StatelessWidget {
  ...
  final AsyncValue<WithdrawalBalance> balanceAsync;
          ...
          children: [
            ...
            Row(
              children: [
                _balanceItem(
                  'Pending',
                  '\$${balance.pendingWithdrawal.toStringAsFixed(2)}',
                ),
...
class _AutoWithdrawalCard extends ConsumerWidget {
  ...
  final AsyncValue<WithdrawalSettings> settingsAsync;
        ...
        data: (settings) => Column(
          ...
          children: [
            ...
            if (settings.autoWithdrawalEnabled) ...[
              ...
              Text(
                'Frequency: ${settings.autoWithdrawalFrequency ?? 'Monthly'}',
                style: const TextStyle(fontSize: 13, color: Color(0xFF555555)),
              ),
              const SizedBox(height: 4),
              Text(
                'Day: ${settings.autoWithdrawalDay ?? 1}',
                style: const TextStyle(fontSize: 13, color: Color(0xFF555555)),
              ),
            ],
          ],
...
class _WithdrawalHistoryList extends StatelessWidget {
  ...
  final AsyncValue<List<WithdrawalRecord>> historyAsync;
  ...
  Widget build(BuildContext context) {
    return historyAsync.when(
      ...
      data: (records) {
        ...
        return Column(
          children: records.map((record) => _WithdrawalTile(record: record)).toList(),
        );
      },
    );
  }
