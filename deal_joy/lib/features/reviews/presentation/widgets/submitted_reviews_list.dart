// 已提交评价列表（无 Scaffold），供 My Coupons Reviews 子 Tab 与 /my-reviews 复用
...
class SubmittedReviewsList extends ConsumerWidget {
  const SubmittedReviewsList({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  const Text(
                    'After you redeem a voucher, post a review — it will show up here.',
                    textAlign: TextAlign.center,
