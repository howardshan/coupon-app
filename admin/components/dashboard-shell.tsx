  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-50 md:flex-row">
      ...
      <div
        ...
        className={
          'fixed inset-y-0 left-0 z-50 w-56 max-w-[85vw] transform bg-gray-900 transition-transform duration-200 ease-out md:static md:z-auto md:max-w-none md:flex-shrink-0 md:translate-x-0 md:bg-transparent ' +
      ...
      <main className="min-h-0 min-w-0 flex-1 overflow-auto p-4 sm:p-6 lg:p-8">{children}</main>
    </div>
  )
}
